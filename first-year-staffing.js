...
function renderFirstYearStaffing(el){
  ...
  el.innerHTML=`
    ...
    <div class="staff-overview"><div class="staff-stat primary"><strong>${p.teachers.length}</strong><span>第一年教師總人數</span><div class="breakdown">5位全職中師＋4位全職外師＋4位專業兼任</div></div><div class="staff-stat"><strong>${ftCt+ftEt}</strong><span>全職教師<br>${ftCt}位中師＋${ftEt}位外師</span></div><div class="staff-stat"><strong>${pt}</strong><span>專業兼任教師<br>數學、人文、藝術、戶外</span></div><div class="staff-stat"><strong>${p.classes.length}</strong><span>第一年招生班級<br>一至三年級</span></div></div>
    <div class="staff-equation"><b>編制公式｜13位教師＝9位全職＋4位兼任</b><div class="staff-equation-note">雙導師共8席由上述13人中的4位中師與4位外師擔任，不另外加計。</div></div>
