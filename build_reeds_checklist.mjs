...
const phases = [
  ...
  ["第四期", "115年12月-116年1月", "寒假試辦、培訓啟動與立案申請期", "透過營隊測試課程、新進師資共識培訓、硬體完工，並於12月15日前遞交正式立案申請"],
  ["第五期", "116年2月-3月", "立案追蹤與正式招生期", "追蹤立案補件、會勘與審查進度，全面啟動招生作業、設備進駐"],
...
const tasks = [
  ...
  ["P5-01", "第四期", "立案申請", "遞交正式立案申請", "完成申請送件，追蹤教育局補件、會勘與審查進度。", "申請文件、收件證明、追蹤表", "高", "行政籌備"],
...
const taskDueDates = {
  "P1-01": new Date("2026-06-25"),
  "P1-02": new Date("2026-06-30"),
  "P5-01": new Date("2026-12-15"),
};
...
const taskRows = tasks.map(t => {
  ...
  return [
    ...
    taskDueDates[t[0]] || phaseEndDates[t[1]], "待開始", null, "", ""
  ];
});
